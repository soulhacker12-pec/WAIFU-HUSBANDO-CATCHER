...
async def upload(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        rarity_map = {1: "⚪ Common", 2: "🟣 Rare", 3: "🟡 Legendary", 4: "🟢 Medium", 5: "💮 Exclusive", 6: "🫧 Special Edition", 7: "🔮 Limited Edition", 8: "🎐 Celestial", 9: "🎄 Christmas", 10: "💘 Valentine", 11: "💋 [𝙓] 𝙑𝙚𝙧𝙨𝙚", 12: "🔞 NSFW", 13: "💋 𝘾𝙊𝙎𝙋𝙇𝘼𝙔 [𝙇]"}
        try:
...
async def update(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        if args[1] in ['name', 'anime']:
            ...
            rarity_map = {1: "⚪ Common", 2: "🟣 Rare", 3: "🟡 Legendary", 4: "🟢 Medium", 5: "💮 Exclusive", 6: "🫧 Special Edition", 7: "🔮 Limited Edition", 8: "🎐 Celestial", 9: "🎄 Christmas", 10: "💘 Valentine", 11: "💋 [𝙓] 𝙑𝙚𝙧𝙨𝙚", 13:"💋 𝘾𝙊𝙎𝙋𝙇𝘼𝙔 [𝙇]"}
...
UPDATE_HANDLER = CommandHandler('h', upload, block=False)
application.add_handler(UPDATE_HANDLER)
